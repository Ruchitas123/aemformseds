...
## Environments
- Preview: https://main--aemformseds--Ruchitas123.hlx.page/
- Live: https://main--aemformseds--Ruchitas123.hlx.live/
...
1. Open the `aemformseds` directory in your favorite IDE and start coding :)
